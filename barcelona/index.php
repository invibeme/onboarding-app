...
<html lang="es-ES">
   <head>
      ...
      <title>Barcelona, 25/10 Legalidad e Innovación en Alojamientos Turísticos | CheKin</title>
      <meta name="robots" content="index">
      <meta description="CheKin organizado junto a Ostelea un encuentro sobre Legalidad e Innovación en alojamientos turísticos. El encuentro tendrá lugar el 25 de octubre de 18:00h a 20:00h en las Instalaciones de Ostelea." />
      <link rel="canonical" href="https://chekin.io/barcelona/" />
	...
	<meta property="og:description" content="CheKin organizado junto a Ostelea un encuentro sobre Legalidad e Innovación en alojamientos turísticos. El encuentro tendrá lugar el 25 de octubre de 18:00h a 20:00h en las Instalaciones de Ostelea.">
	<meta property="og:image" content="https://chekin.io/barcelona/images/facebookcard.png">
	<meta property="og:image:width" content="1200">
	<meta property="og:image:height" content="628">
	<meta property="og:site_name" content="CheKin">
	<meta property="og:title" content="Barcelona, 25/10 Legalidad e Innovación en Alojamientos Turísticos | CheKin">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://chekin.io/barcelona/">

	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:site" content="@chekinapp">
	<meta name="twitter:creator" content="@chekinapp">
	<meta name="twitter:title" content="Barcelona, 25/10 Legalidad e Innovación en Alojamientos Turísticos | CheKin">
	<meta name="twitter:description" content="CheKin organizado junto a Ostelea un encuentro sobre Legalidad e Innovación en alojamientos turísticos. El encuentro tendrá lugar el 25 de octubre de 18:00h a 20:00h en las Instalaciones de Ostelea.">
	<meta name="twitter:image" content="https://chekin.io/barcelona/images/facebookcard.png">
		...
		<section class="pt-5 banner main snaptoHeader text-center">
            <div class="container panel-grid-cell">
			  ...
			  <div class="col-12 col-xl-10 mx-auto mb-3">
				<h1>Legalidad e Innovación en Alojamientos Turísticos - Barcelona - 25 de octubre</h1>
			  <p class="countDown pb-lg-4 pt-xl-3 mb-xl-5 opacity1" id="countDown">
				
				<?php
					echo countDown(date('Y-m-d H:i:s'), "2018-10-25 00:00:00");
				?>
			...
			<p><img src="/barcelona/images/facebookcard.png" alt="CheKin Ostelea evento Barcelona 25 octubre 2018" /></p>
				<p class="lead2" style="font-size:20px !important">¿Tienes un alojamiento turístico en Barcelona? ¿Te interesa la innovación turística? Este es tu evento. CheKin organizado junto a Ostelea un encuentro sobre Legalidad e Innovación en alojamientos turísticos. El encuentro tendrá lugar el 25 de octubre de 18:00h a 20:00h en las Instalaciones de Ostelea (Carrer d'Aragó, 28, 08015 Barcelona).</p>
				<p class="lead2" style="font-size:20px">En el evento se presentará un informe con datos relevantes del sector, se debatirá sobre tecnología en establecimientos turísticos en una mesa redonda llena de expertos (Vodafone, ATA, Rentals United, Ostelea y CheKin) y contaremos con una ponencia legal de la mano de Marinel-lo @ Partners Abogados.</p>
				<p class="lead2" style="font-size:28px">¡Regístrate abajo y <a href="https://chekin.io/barcelona/programa-chekin-ostelea-25-10.pdf" target="_blank" style="color: #FF7627; text-decoration: underline">descarga el programa del evento</a>!</p>
			  </div>	
			  </div>
            </div>
			<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfQxncvd6aJu5bdXtQdU8N5c7pTmhJVhxosJ-6gj-fw-ms0pw/viewform?embedded=true" width="640" height="1025" frameborder="0" marginheight="0" marginwidth="0">Cargando...</iframe>
         </section>
                        ...
                        <div class="btn-cont btn-primary-cont downloadApp panel-widget-style panel-widget-style-for-10-0-0-1">
                           <div class="so-widget-sow-button so-widget-sow-button-atom-4a75a8acc3b6">
                              <div class="ow-button-base ow-button-align-center">
                                 <a href="https://app.chekin.io/descargar?utm_medium=ppc&utm_source=web-landing-barcelona-25-10&utm_campaign=none" class="ow-icon-placement-left ow-button-hover" target="_blank">
