...
<?php 
	...
	$output = '';
	$output .= '<figure class="figure"><a href="'. get_the_permalink() .'"><img src="'.get_template_directory_uri().'/timthumb.php?src='. $post_thumbnail_url.'&amp;w=352&amp;h=221&amp;zc=1&amp;a=t" alt="" ></a></figure>';
