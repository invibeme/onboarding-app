<?php
/**
 * A template partial to output pagination for the Chekin 2020 default theme.
 *
...
$prev_text = sprintf(
	...
	__( 'Previous <span class="nav-short">Posts</span>', 'chekin2020' )
);
$next_text = sprintf(
	'<span class="nav-next-text">%s</span> %s',
	__( 'Next <span class="nav-short">Posts</span>', 'chekin2020' ),
