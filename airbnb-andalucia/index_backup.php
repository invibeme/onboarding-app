...
<html lang="it-IT">
   <head>
      ...
      <title>CheKin | Applicazione mobile che rivoluziona la gestione della tua struttura ricettiva</title>
   ...
   <body class="home">
      <header id="masthead" class="site-header" role="banner">
         <nav id="site-navigation" class="main-navigation navbar navbar-expand-xl navbar-dark fixed-top bg-transparent">
            <div class="container">
               <div class="navbar-brand">
                  <a href="#" class="custom-logo-link" rel="home" itemprop="url"><img width="161" height="29" src="images/logo.png" class="custom-logo" alt="CheKin" itemprop="logo"></a>			 
                  <a href="#" class="bloginfo screen-reader-text" rel="home">CheKin</a> 
               </div>
               <!-- .site-branding -->
               ...
               <div id="navigation" class="collapse navbar-collapse">
                  <ul id="menu-main-menu" class="navbar-nav ml-auto	">
                     <li><a href="#">¿Qué es CheKin?</a></li>
                     <li class="btnCont"><a target="_blank" href="https://app.chekin.io/descargar?utm_medium=ppc&utm_source=web-landing-airbnb-30-09">DESCARGA LA APP</a></li>
                     <li><a href="#">Hoteles</a></li>
                     <li><a href="#">Equipo</a></li>
                     <li><a href="#">Blog</a></li>
                     <li><a href="#">Faq</a></li>
                     <li><a href="#">Contacto</a></li>
                     <li><a target="_blank" href="#">Soporte</a></li>
                     <li><a href="tel:+34668690744">+34 668 690 744</a></li>
                     <li class="menu-item wpml-ls-slot-13 wpml-ls-item wpml-ls-item-es wpml-ls-current-language wpml-ls-menu-item wpml-ls-first-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-has-children menu-item-wpml-ls-13-es" aria-haspopup="true">
                        <a title="Español" href="#"><img class="wpml-ls-flag" src="images/es.png" alt="es" title="Español"><span class="wpml-ls-native">Español</span></a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expande el menú inferior</span></button>
                        <ul class="sub-menu">
                           <li id="menu-item-wpml-ls-13-ca" class="menu-item wpml-ls-slot-13 wpml-ls-item wpml-ls-item-ca wpml-ls-menu-item wpml-ls-last-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-13-ca"><a title="Català" href="#"><img class="wpml-ls-flag" src="images/ca.png" alt="ca" title="Català"><span class="wpml-ls-native">Català</span></a></li>
                        </ul>
                     </li>
                  </ul>
               </div>
		...
		<section class="pt-5 banner main snaptoHeader text-center">
            <div class="container panel-grid-cell">
			  ...
			  <p class="countDown pb-lg-4 pt-xl-3 mb-xl-5 opacity1" id="countDown">
				...
				<?php
					echo countDown(date('Y-m-d H:i:s'), "2018-09-23 24:00:00");
				?>
				...
				<div class="row steps mt-lg-5">
					<div class="col-12 col-md-4">
						<a href="https://chekin.io/blog/airbnb-excluir-viviendas-turisticas-no-registradas-en-andalucia/" target="_blank" class="panel h3 bg-purple">
					...
					<div class="col-12 col-md-4">
						<a href="https://app.chekin.io/descargar?utm_medium=ppc&utm_source=web-landing-airbnb-30-09" target="_blank" class="panel h3 bg-orange">
                        ...
                        <div class="btn-cont btn-primary-cont downloadApp panel-widget-style panel-widget-style-for-10-0-0-1">
                           <div class="so-widget-sow-button so-widget-sow-button-atom-4a75a8acc3b6">
                              <div class="ow-button-base ow-button-align-center">
                                 <a href="https://app.chekin.io/descargar?utm_medium=ppc&utm_source=web-landing-airbnb-30-09" class="ow-icon-placement-left ow-button-hover" target="_blank" rel="noopener noreferrer">
                                 <span>
