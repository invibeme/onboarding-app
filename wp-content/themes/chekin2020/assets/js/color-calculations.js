 ...
 * @return {Object} - this
 */
function _chekin2020Color( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_chekin2020Color.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_chekin2020Color.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_chekin2020Color.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _chekin2020Color object.
 *
 * @since Chekin 2020 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function chekin2020Color( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _chekin2020Color( backgroundColor, accentHue );
